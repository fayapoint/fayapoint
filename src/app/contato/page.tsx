    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="pt-24 pb-12">
        <div className="container mx-auto px-4 max-w-2xl">
          ...
          <p className="text-gray-400 mb-6">Fale conosco para parcerias, mídia e suporte.</p>
          <div className="grid gap-4">
            ...
            <textarea className="bg-gray-900 border border-gray-800 rounded p-3" rows={5} placeholder="Mensagem" />
