...
/**
 * `verificar-certificado` fora do índice.
 *
 * O robots.txt bloqueia `/verificar-certificado`, mas o padrão não casa com o prefixo de
 * locale: a URL real é `/pt-BR/verificar-certificado`. Medido em produção em 29/07/2026,
...
export const metadata: Metadata = {
  title: "Verificar certificado | FayAI",
