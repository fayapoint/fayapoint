...
/**
 * `receipt` fora do índice.
 *
 * O robots.txt bloqueia `/receipt`, mas o padrão não casa com o prefixo de
 * locale: a URL real é `/pt-BR/receipt`. Medido em produção em 29/07/2026,
