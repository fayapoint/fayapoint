...
import fatia from "../../../../../messages/rotas/checkout.json";
import { ProvedorDeRota } from "@/i18n/rota";

/**
 * `checkout` fora do índice.
 *
 * O robots.txt bloqueia `/checkout`, mas o padrão não casa com o prefixo de
 * locale: a URL real é `/pt-BR/checkout`. Medido em produção em 29/07/2026,
