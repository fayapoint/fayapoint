...
/**
 * `configuracoes` fora do índice.
 *
 * O robots.txt bloqueia `/configuracoes`, mas o padrão não casa com o prefixo de
 * locale: a URL real é `/pt-BR/configuracoes`. Medido em produção em 29/07/2026,
