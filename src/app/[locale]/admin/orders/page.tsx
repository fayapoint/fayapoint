              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-border">
                    <th className="text-left py-4 px-4 text-sm font-medium text-muted-foreground">Pedido</th>
      ...
      {selectedOrder && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-lg rounded-2xl bg-card border border-border p-6"
          >
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-xl bg-secondary">
                ...
                <p className="text-sm text-muted-foreground">{selectedOrder.userEmail || "N/A"}</p>
              </div>
