      ...
      <td className="py-4 px-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground truncate max-w-[200px]">{slug}</p>
          </div>
        </div>
      </td>
            ...
            {showMenu && (
              <>
                ...
                <motion.div
                  ...
                  className="absolute right-0 top-full mt-1 w-40 rounded-xl bg-card border border-border shadow-xl z-50 overflow-hidden"
                >
                  <button
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        className="relative w-full max-w-2xl max-h-[80vh] rounded-2xl bg-card border border-border overflow-hidden"
      >
        <div className="flex items-center justify-between p-4 border-b border-border">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={handleCopy}
              className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-secondary text-muted-foreground hover:bg-white/10 transition text-sm"
            >
    ...
    <div className="space-y-2">
      ...
      <div className="flex gap-3">
        <div 
          ...
          className="w-24 h-24 rounded-xl bg-secondary border border-border flex items-center justify-center cursor-pointer hover:bg-white/10 transition overflow-hidden relative"
        >
          {uploading ? (
        ...
        <div className="flex-1">
          ...
          />
          <p className="text-xs text-muted-foreground mt-1">Clique na caixa ou cole uma URL</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        animate={{ opacity: 1, scale: 1, y: 0 }}
        exit={{ opacity: 0, scale: 0.95, y: 20 }}
        className="relative w-full max-w-4xl max-h-[90vh] rounded-2xl bg-card border border-border shadow-2xl overflow-hidden flex flex-col"
      >
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">fayapoint.storeproducts</p>
            </div>
          </div>
          <button onClick={onClose} className="text-muted-foreground hover:text-white">
            <X size={24} />
        ...
        {/* Tabs */}
        <div className="flex gap-2 px-6 py-3 border-b border-border bg-white/[0.02]">
          {tabs.map(tab => (
            <button
              key={tab.id}
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6">
          {activeTab === "basic" && (
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-sm text-muted-foreground font-medium mb-1 block">Nome do Produto *</label>
                  <input
                    type="text"
                    value={formData.name}
                ...
                <div>
                  <label className="text-sm text-muted-foreground font-medium mb-1 block">Slug (URL)</label>
                  <input
                    type="text"
                    value={formData.slug}
              ...
              <div>
                <label className="text-sm text-muted-foreground font-medium mb-1 block">Descrição Curta</label>
                <input
                  type="text"
              ...
              <div>
                <label className="text-sm text-muted-foreground font-medium mb-1 block">Descrição Completa</label>
                <textarea
                  value={formData.fullDescription}
                  onChange={(e) => updateField("fullDescription", e.target.value)}
                  rows={4}
                  className="w-full px-4 py-3 rounded-xl bg-secondary border border-border text-white focus:outline-none focus:border-amber-500/50 resize-none"
                />
              </div>

              <div className="grid grid-cols-3 gap-4">
                <div>
                  <label className="text-sm text-muted-foreground font-medium mb-1 block">Categoria</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="text-sm text-muted-foreground font-medium mb-1 block">Subcategoria</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="text-sm text-muted-foreground font-medium mb-1 block">Marca</label>
                  <input
                    type="text"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-sm text-muted-foreground font-medium mb-1 block">SKU</label>
                  <input
                    type="text"
                    value={formData.sku}
                ...
                <div>
                  <label className="text-sm text-muted-foreground font-medium mb-1 block">Garantia</label>
                  <input
                    type="text"
              ...
              <div>
                <label className="text-sm text-muted-foreground font-medium mb-1 block">URL Externa (opcional)</label>
                <input
                  type="url"
              ...
              {/* Tags */}
              <div>
                <label className="text-sm text-muted-foreground font-medium mb-2 block">Tags</label>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2 rounded-xl bg-secondary border border-border text-white text-sm focus:outline-none focus:border-amber-500/50"
                  />
          ...
          {activeTab === "pricing" && (
            <div className="space-y-4">
              <div className="grid grid-cols-3 gap-4">
                <div>
                  <label className="text-sm text-muted-foreground font-medium mb-1 block">Preço (R$) *</label>
                  <input
                    type="number"
                    step="0.01"
                ...
                <div>
                  <label className="text-sm text-muted-foreground font-medium mb-1 block">Preço Original (R$)</label>
                  <input
                    type="number"
                    step="0.01"
                ...
                <div>
                  <label className="text-sm text-muted-foreground font-medium mb-1 block">Desconto (%)</label>
                  <input
                    type="number"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-sm text-muted-foreground font-medium mb-1 block">Estoque *</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="text-sm text-muted-foreground font-medium mb-1 block">Moeda</label>
                  <select
                ...
                <div className="grid grid-cols-3 gap-4">
                  <label className="flex items-center gap-3 cursor-pointer">
                    <input
                      ...
                      className="w-5 h-5 rounded bg-secondary border border-white/20 text-amber-500 focus:ring-amber-500"
                    />
                  ...
                  <label className="flex items-center gap-3 cursor-pointer">
                    <input
                      ...
                      className="w-5 h-5 rounded bg-secondary border border-white/20 text-amber-500 focus:ring-amber-500"
                    />
                    <span className="text-sm text-muted-foreground">Novidade</span>
                  </label>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  <label className="text-sm text-muted-foreground font-medium mb-1 block">Avaliação</label>
                  <input
                    type="number"
                    step="0.1"
                    min="0"
                ...
                <div>
                  <label className="text-sm text-muted-foreground font-medium mb-1 block">Nº Avaliações</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="text-sm text-muted-foreground font-medium mb-1 block">Vendidos</label>
                  <input
                    type="number"
          ...
          {activeTab === "media" && (
            <div className="space-y-6">
              ...
              <div>
                <label className="text-sm text-muted-foreground font-medium mb-2 block">Galeria de Imagens</label>
                <div className="grid grid-cols-4 gap-3">
                  ...
                  <div 
                    ...
                    className="w-full aspect-square rounded-lg bg-secondary border border-dashed border-white/20 flex flex-col items-center justify-center cursor-pointer hover:bg-white/10 transition"
                  >
        ...
        {/* Footer */}
        <div className="flex gap-3 p-6 border-t border-border bg-white/[0.02]">
          <button
            type="button"
            onClick={onClose}
            className="flex-1 px-4 py-3 rounded-xl bg-secondary border border-border text-muted-foreground hover:bg-white/10 transition font-medium"
          >
            Cancelar
          </button>
          <button
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        animate={{ opacity: 1, scale: 1, y: 0 }}
        exit={{ opacity: 0, scale: 0.95, y: 20 }}
        className="relative w-full max-w-3xl rounded-2xl bg-card border border-border p-6 shadow-2xl"
      >
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">{database}.{collection}</p>
          </div>
          <button onClick={onClose} className="text-muted-foreground hover:text-white">
            <X size={20} />
          </button>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="text-sm text-muted-foreground mb-1 block">JSON do Documento</label>
            <textarea
              value={jsonData}
              onChange={(e) => setJsonData(e.target.value)}
              className="w-full h-96 px-4 py-3 rounded-xl bg-secondary border border-border text-white font-mono text-sm focus:outline-none focus:border-amber-500/50 resize-none"
              spellCheck={false}
            />
          </div>
    ...
    <div className="space-y-6">
      ...
      <div className="p-4 rounded-xl bg-gradient-to-br from-amber-500/10 to-amber-500/5 border border-amber-500/20">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1">
            <label className="text-xs text-muted-foreground mb-1 block">Banco de Dados</label>
            <select
              value={database}
          ...
          <div className="flex-1">
            <label className="text-xs text-muted-foreground mb-1 block">Coleção</label>
            <select
              value={collection}
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-border">
                    ...
                    <th className="text-left py-4 px-4 text-sm font-medium text-muted-foreground">Criado</th>
