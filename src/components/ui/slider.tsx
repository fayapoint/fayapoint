...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    <SliderPrimitive.Thumb className="block h-4 w-4 rounded-full border border-purple-500/50 bg-purple-600 shadow transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-purple-400 disabled:pointer-events-none disabled:opacity-50 hover:bg-purple-500 cursor-grab active:cursor-grabbing" />
  </SliderPrimitive.Root>
))
