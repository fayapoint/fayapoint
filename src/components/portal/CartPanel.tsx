      ...
      >
        ...
        <div className="relative rounded-2xl overflow-hidden">
          ...
          <div className="relative p-4 flex gap-4">
            {/* Image */}
            <div className="w-20 h-20 rounded-xl bg-gradient-to-br from-gray-800 to-card flex-shrink-0 overflow-hidden">
              {item.image ? (
      ...
      <div className="flex items-center justify-between">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="bg-secondary border border-border p-1 h-auto">
            <TabsTrigger value="cart" className="data-[state=active]:bg-amber-500/20 data-[state=active]:text-amber-400 gap-2 px-4 py-2">
              <ShoppingCart size={16} />
              Carrinho
              {itemCount > 0 && (
                <Badge className="bg-amber-500 text-white text-[10px] px-1.5 ml-1">{itemCount}</Badge>
              )}
            </TabsTrigger>
            <TabsTrigger value="history" className="data-[state=active]:bg-amber-500/20 data-[state=active]:text-amber-400 gap-2 px-4 py-2">
              <History size={16} />
              Histórico
            </TabsTrigger>
          </TabsList>
        ...
        {activeTab === "history" && (
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <Button variant="outline" size="sm" className="border-border gap-2" onClick={fetchOrders}>
                <Download size={14} />
                Atualizar
              </Button>
            </div>
                ...
                <div key={order._id} className="relative rounded-2xl overflow-hidden">
                  ...
                  <div className="relative p-5">
                      ...
                      {order.items.map((item: OrderItem, idx: number) => (
                        <div key={idx} className="flex items-center justify-between text-sm">
                          <div className="flex items-center gap-2">
                            {item.type === "product" ? <Package size={14} className="text-muted-foreground" /> : 
                             item.type === "course" ? <BookOpen size={14} className="text-muted-foreground" /> :
                    ...
                    <div className="flex gap-2 mt-4 pt-4 border-t border-border">
                      <Button variant="outline" size="sm" className="border-border gap-2 flex-1">
                        <Receipt size={14} />
                        Ver Detalhes
                      </Button>
