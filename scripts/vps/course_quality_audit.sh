...
docker exec -u 10000 -e OPENROUTER_BASE_URL=http://127.0.0.1:7860/v1 -e OPENROUTER_API_KEY=kirmes-local kirmes /opt/hermes/.venv/bin/hermes -z "$TASK" 2>&1 | tee "$HERMES_OUT" >> "$LOG"
STATUS=${PIPESTATUS[0]}
