...
aprenda-a-usar-inteligencia-artificial-no-seu-dia-a-dia. Curso gerado do MESMO
boilerplate do chatgpt-zero (ancoras estruturais identicas), so os temas
visuais mudam para refletir uso cotidiano de IA (rotina, produtividade,
comunicacao, estudo, criacao, seguranca).
...
# 6 temas do curso (1 por modulo, refletindo IA no dia a dia) -> cenario + glow
THEMES = [
