...
const BACKUP_COLL = `products_backup_leitura20_${SLUG.replace(/-/g, '_')}_20260802`;
...
const SLOTS = [
  { slot: 'sistema', type: 'img', afterNthParagraphOf: ['## Conceitos-Chave', 1],
    caption: 'Todo vídeo gerado é uma pilha de decisões: roteiro, primeiro quadro, movimento, som e corte. Uma camada fraca derruba o resultado inteiro, por melhor que sejam as outras.' },
  { slot: 'intencao', type: 'img', afterNthParagraphOf: ['## Conceitos-Chave', 2],
    caption: 'Decidir antes de gerar: o que o vídeo precisa provar, para quem, em quantos segundos. Gerar primeiro e decidir depois é o que queima crédito.' },
  { slot: 'fluxo', type: 'video', afterSection: '## Fluxo de Execução',
    caption: 'O caminho completo: roteiro → primeiro quadro → geração → som → montagem → publicação. Este clipe foi gerado com o mesmo tipo de ferramenta que o capítulo ensina.' },
  { slot: 'cenario', type: 'img', afterNthParagraphOf: ['## Cenários Aplicados', 1],
    caption: 'De material solto a vídeo publicável: o que muda entre ter clipes bonitos e ter uma peça que alguém assiste até o fim.' },
  { slot: 'validacao', type: 'img', afterSection: '## Erros Comuns',
    caption: 'Antes de publicar: conferir direitos da trilha, marca d’água, proporção e os três primeiros segundos. É onde o vídeo pronto ainda pode dar errado.' },
  { slot: 'dica', type: 'video', afterBlockquote: '**Dica Pro:**',
    caption: 'O atalho que economiza mais crédito: gerar em baixa resolução para testar a ideia, e só subir a qualidade quando o movimento já estiver certo.' },
];
